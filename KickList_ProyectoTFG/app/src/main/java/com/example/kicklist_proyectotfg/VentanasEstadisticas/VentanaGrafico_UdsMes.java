...
public class VentanaGrafico_UdsMes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ventana_grafico_uds_mes);
        ...
        btn_volver_grafico_uds.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(VentanaGrafico_UdsMes.this, VentanaEstadisticas.class);
    ...
    private void actualizarGrafico(String anio) {
        ...
        Map<String, Integer> ventasPorMes = db.obtenerVentasPorMes(anio);
        ...
        for (Map.Entry<String, Integer> entry : ventasPorMes.entrySet()) {
            // Añadir el número de unidades vendidas
        ...
        BarDataSet dataSet = new BarDataSet(entries, "Unidades vendidas en " + anio);
        ...
        dataSet.setValueFormatter(new ValueFormatter() {
            ...
            public String getBarLabel(BarEntry barEntry) {
                // Formatear el valor sin decimales
        ...
        // Establecer el color de la leyenda
